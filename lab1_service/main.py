...
# Postgres
pg_conn = psycopg2.connect(host="localhost", port="5432", database="university_db", user="user",
                           password="password")
...
async def get_low_attendance_report(
    ...
    try:
        ...
        logging.INFO('common els ',common_elements)
...
#Postgres
pg_conn = psycopg2.connect(host="localhost", port="5432", database="university_db", user="user", password="password")
